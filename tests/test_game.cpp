...
TEST(PawnCheck, BlackInCheck)
{
  ...
  Game game(fen);
  PiecePlacement piece_placement = game.get_piece_placement();
  ASSERT_TRUE(Game::is_king_in_check(PieceColor::Black, piece_placement));
}
...
TEST(PawnCheck, WhiteInCheck)
{
  ...
  Game game(fen);
  PiecePlacement piece_placement = game.get_piece_placement();
  ASSERT_TRUE(Game::is_king_in_check(PieceColor::White, piece_placement));
}
